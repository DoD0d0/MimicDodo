...
The Dodo robot configuration uses the centralized assets from the MimicDodo project root:
- **URDF**: `assets/dodo/urdf/dodo.urdf`
- **Meshes**: `assets/dodo/meshes/`

The robot configuration in `robots/dodo.py` automatically calculates the path to these centralized assets, ensuring consistency across all projects in the MimicDodo repository.
